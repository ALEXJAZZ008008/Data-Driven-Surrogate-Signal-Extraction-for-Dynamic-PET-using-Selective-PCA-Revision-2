...
\begin{document}
    ...
    \begin{abstract}
        ...
        \paragraph{Main results} The results indicate that all methods produce better surrogate signals than when applying conventional PCA to dynamic data (for instance a higher correlation with a gold standard respiratory trace). Extrapolating a late principal component, produced more promising results than using a moving window, and scoring, selecting, and combining components held benefits over all other methods.
